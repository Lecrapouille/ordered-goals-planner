...
void planningDummyExample()
{
  ...
  assert(sayHi == firstActionInPlan.actionInvocation.actionId);
...
void planningExampleWithAPreconditionSolve()
{
  ...
  assert(sayHi == firstActionInPlan1.actionInvocation.actionId);
  // When the action is finished we notify the planner
  ...
  assert(askHowICanHelp == firstActionInPlan2.actionInvocation.actionId);
  // When the action is finished we notify the planner
